...
This is the second post in the SOLID series. If you missed the first post on the Single Responsibility Principle or just want to go over it again for good measure, that can be found [here]({% post_url 2018-01-28-srp %}).
